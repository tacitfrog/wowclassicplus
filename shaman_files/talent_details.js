...
rank[i] = [
		"Your Earth Shock spell and Lightning Shield orbs also cause half damage and full threat to all other enemies within 3 yards of the target.<br><br>[Note: The interrupt component of Earth Shock only affects the target.  The 'target' of Lightning Shield is the enemy that triggers it.  The copied damage cannot crit; but if Earth Shock crits the target, the increased damage is copied.  The damage that each enemy suffers is halved and then modified by its own effects and Nature resistance.  The full threat caused by the original attack is copied to all affected enemies.]"
		];
i++;
