...
talent[i] = [1, "Spirit Weapons", "changed", 1, 3, 5]; i++;
...
rank[i] = [
		"Gives a chance to parry enemy melee attacks.  In addition, unless your weapon is imbued with Rockbiter Weapon, the threat generated by your melee attacks is reduced by 30%."
		];
i++;
