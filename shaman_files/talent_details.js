...
rank[i] = [
		"Critical strikes from your Flametongue and Frostbrand weapon effects, your Fire Totems, and your Fire, Frost, and Nature spells will increase your chance to get a critical strike with weapon attacks by 3% for 10 seconds.",
		"Critical strikes from your Flametongue and Frostbrand weapon effects, your Fire Totems, and your Fire, Frost, and Nature spells will increase your chance to get a critical strike with weapon attacks by 6% for 10 seconds.",
		"Critical strikes from your Flametongue and Frostbrand weapon effects, your Fire Totems, and your Fire, Frost, and Nature spells will increase your chance to get a critical strike with weapon attacks by 9% for 10 seconds."
		];
i++;
...
rank[i] = [
		"Reduces the delay before your Fire Nova Totem activates by 1 second, decreases the threat generated by your Magma Totem by 25%, and increases the critical strike chance of your Searing Totem by 2%.",
		"Reduces the delay before your Fire Nova Totem activates by 2 seconds, decreases the threat generated by your Magma Totem by 50%, and increases the critical strike chance of your Searing Totem by 4%."
		];
i++;
...
rank[i] = [
		"Critical strikes from your shock, Lightning Bolt, and Chain Lightning spells, and from your weapon attacks, have a 15% chance to cause one of your Lightning Shield orbs to strike the target as well.<br><br>[Note: This effect shares the Lightning Shield proc timer - orbs cannot proc more than once every few seconds, regardless of whether they are triggered by this talent or in the usual way.]",
		"Critical strikes from your shock, Lightning Bolt, and Chain Lightning spells, and from your weapon attacks, have a 30% chance to cause one of your Lightning Shield orbs to strike the target as well.<br><br>[Note: This effect shares the Lightning Shield proc timer - orbs cannot proc more than once every few seconds, regardless of whether they are triggered by this talent or in the usual way.]",
		"Critical strikes from your shock, Lightning Bolt, and Chain Lightning spells, and from your weapon attacks, have a 45% chance to cause one of your Lightning Shield orbs to strike the target as well.<br><br>[Note: This effect shares the Lightning Shield proc timer - orbs cannot proc more than once every few seconds, regardless of whether they are triggered by this talent or in the usual way.]"
		];
i++;
...
rank[i] = [
		"Increases the critical strike damage bonus of your Flametongue and Frostbrand weapons effects, your Fire Totems, and your Fire, Frost, and Nature spells by 100%."
		];
i++;
...
rank[i] = [
		"Grants the Shaman an effect as long as his weapon is imbued with elemental power.<br><br>Rockbiter - Gives a 10% chance to restore an orb to your Lightning Shield whenever your weapon hits a foe.  The chance is doubled if you critically hit.<br><br>Windfury - Increases the attack power bonus of your Windfury Weapon effect by 13%.<br><br>Flametongue - Increases the damage caused by your Flametongue Weapon by 10%.<br><br>Frostbrand - Gives a 10% chance to immobilise the target for 3 seconds whenever Frostbrand triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot exceed its maximum number of orbs.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active.  The Frostbrand extra effect uses Frost Nova graphics.]",
		"Grants the Shaman an effect as long as his weapon is imbued with elemental power.<br><br>Rockbiter - Gives a 20% chance to restore an orb to your Lightning Shield whenever your weapon hits a foe.  The chance is doubled if you critically hit.<br><br>Windfury - Increases the attack power bonus of your Windfury Weapon effect by 26%.<br><br>Flametongue - Increases the damage caused by your Flametongue Weapon by 20%.<br><br>Frostbrand - Gives a 20% chance to immobilise the target for 3 seconds whenever Frostbrand triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot exceed its maximum number of orbs.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active.  The Frostbrand extra effect uses Frost Nova graphics.]",
		"Grants the Shaman an effect as long as his weapon is imbued with elemental power.<br><br>Rockbiter - Gives a 30% chance to restore an orb to your Lightning Shield whenever your weapon hits a foe.  The chance is doubled if you critically hit.<br><br>Windfury - Increases the attack power bonus of your Windfury Weapon effect by 40%.<br><br>Flametongue - Increases the damage caused by your Flametongue Weapon by 30%.<br><br>Frostbrand - Gives a 30% chance to immobilise the target for 3 seconds whenever Frostbrand triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot exceed its maximum number of orbs.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active.  The Frostbrand extra effect uses Frost Nova graphics.]"
		];
i++;
//Parry - Enhancement
rank[i] = [
...
rank[i] = [
		"Your Earth Shock spell and Lightning Shield orbs also cause half damage and full threat to all other enemies within 3 yards of the target.<br><br>[Note: The interrupt component of Earth Shock only affects the target.  The 'target' of Lightning Shield is the enemy that triggers it.  The copied damage cannot crit; but if Earth Shock crits the target or the target is afflicted with Stormstrike, the increased damage is copied.  The copied damage that each other enemy suffers is halved and then modified by its own effects and Nature resistance.  The full threat caused by the original attack is copied to all affected enemies.]"
		];
i++;
...
rank[i] = [
		...
		"Increases the amount healed by your Chain Heal spell to targets after the first by 20%."
		];
i++;
