...
rank[i] = [
		"Grants the Shaman an effect as long as his weapon is imbued.<br><br>Rockbiter Weapon - Gives a 15% chance to restore an orb to your Lightning Shield whenever you block or parry an attack.<br><br>Windfury Weapon - Increases your critical strike chance with weapons by 1%.<br><br>Flametongue Weapon - Increases your attack speed by 2%.<br><br>Frostbrand Weapon - Gives a 7% chance to immobilise the target for 3 seconds whenever your Frostbrand effect triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot have more than 3 orbs at a time.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active or if you are using Water Shield.  The Frostbrand extra effect uses the graphics of the Mage spell Frost Nova.]",
		"Grants the Shaman an effect as long as his weapon is imbued.<br><br>Rockbiter Weapon - Gives a 30% chance to restore an orb to your Lightning Shield whenever you block or parry an attack.<br><br>Windfury Weapon - Increases your critical strike chance with weapons by 2%.<br><br>Flametongue Weapon - Increases your attack speed by 4%.<br><br>Frostbrand Weapon - Gives a 14% chance to immobilise the target for 3 seconds whenever your Frostbrand effect triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot have more than 3 orbs at a time.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active or if you are using Water Shield.  The Frostbrand extra effect uses the graphics of the Mage spell Frost Nova.]",
		"Grants the Shaman an effect as long as his weapon is imbued.<br><br>Rockbiter Weapon - Gives a 45% chance to restore an orb to your Lightning Shield whenever you block or parry an attack.<br><br>Windfury Weapon - Increases your critical strike chance with weapons by 3%.<br><br>Flametongue Weapon - Increases your attack speed by 6%.<br><br>Frostbrand Weapon - Gives a 20% chance to immobilise the target for 3 seconds whenever your Frostbrand effect triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot have more than 3 orbs at a time.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active or if you are using Water Shield.  The Frostbrand extra effect uses the graphics of the Mage spell Frost Nova.]"
		];
i++;
//Parry - Enhancement
rank[i] = [
