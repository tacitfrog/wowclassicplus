...
rank[i] = [
		"Increases the melee attack power bonus of your Windfury Totem by 15% and increases the damage caused by your Flametongue Totem by 10%.",
		"Increases the melee attack power bonus of your Windfury Totem by 30% and increases the damage caused by your Flametongue Totem by 20%."
		];
i++;
//Elemental Weapons - Enhancement
rank[i] = [
		"Increases the melee attack power bonus of your Rockbiter Weapon by 7%, your Windfury Weapon effect by 13%, and increases the damage caused by your Flametongue Weapon and Frostbrand Weapon by 10%.",
		"Increases the melee attack power bonus of your Rockbiter Weapon by 14%, your Windfury Weapon effect by 27%, and increases the damage caused by your Flametongue Weapon and Frostbrand Weapon by 20%.",
		"Increases the melee attack power bonus of your Rockbiter Weapon by 20%, your Windfury Weapon effect by 40%, and increases the damage caused by your Flametongue Weapon and Frostbrand Weapon by 30%."
		];
i++;
//Parry - Enhancement
rank[i] = [
