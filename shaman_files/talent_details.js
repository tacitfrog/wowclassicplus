...
rank[i] = [
		"Increases the number of orbs in your Lightning Shield by 1.  In addition, 5% of your mana regeneration may continue while casting as long as you have an elemental shield active.",
		"Increases the number of orbs in your Lightning Shield by 2.  In addition, 10% of your mana regeneration may continue while casting as long as you have an elemental shield active.",
		];
i++;
...
rank[i] = [
		"Grants the Shaman an effect as long as his weapon is imbued with elemental power.<br><br>Rockbiter - Gives a 8% chance to restore an orb to your Lightning Shield whenever your weapon hits a foe.  The chance is doubled if you critically hit.<br><br>Windfury - Reduces the threat generated by your weapon attacks by 2%.<br><br>Flametongue - Increases your attack speed by 2%.<br><br>Frostbrand - Gives a 8% chance to immobilise the target for 3 seconds whenever Frostbrand triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot exceed its maximum number of orbs.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active.  The Frostbrand extra effect uses Frost Nova graphics.]",
		"Grants the Shaman an effect as long as his weapon is imbued with elemental power.<br><br>Rockbiter - Gives a 16% chance to restore an orb to your Lightning Shield whenever your weapon hits a foe.  The chance is doubled if you critically hit.<br><br>Windfury - Reduces the threat generated by your weapon attacks by 4%.<br><br>Flametongue - Increases your attack speed by 4%.<br><br>Frostbrand - Gives a 16% chance to immobilise the target for 3 seconds whenever Frostbrand triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot exceed its maximum number of orbs.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active.  The Frostbrand extra effect uses Frost Nova graphics.]",
		"Grants the Shaman an effect as long as his weapon is imbued with elemental power.<br><br>Rockbiter - Gives a 25% chance to restore an orb to your Lightning Shield whenever your weapon hits a foe.  The chance is doubled if you critically hit.<br><br>Windfury - Reduces the threat generated by your weapon attacks by 6%.<br><br>Flametongue - Increases your attack speed by 6%.<br><br>Frostbrand - Gives a 25% chance to immobilise the target for 3 seconds whenever Frostbrand triggers.<br><br>[Note: The Rockbiter extra effect cannot occur more than once per second.  Your Lightning Shield cannot exceed its maximum number of orbs.  It does not increase the spell duration.  It has no effect if you do not have Lightning Shield active.  The Frostbrand extra effect uses Frost Nova graphics.]"
		];
i++;
//Parry - Enhancement
rank[i] = [
