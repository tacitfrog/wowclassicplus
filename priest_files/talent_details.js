...
rank[i] = [
		...
		"Reduces the cooldown of your Fade ability by 6 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 3 seconds and the threat generated by your other Shadow spells is reduced by 15% while it is active.<br><br>[Note: The duration and threat reduction components also apply to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus.]"
		];
i++;
//Shadow Reach - Shadow
rank[i] = [
