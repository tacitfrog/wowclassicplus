...
talent[i] = [2, "Improved Fade", "changed", 3, 2, 4]; i++;
...
talent[i] = [2, "Mind Melt", "new", 3, 4, 5]; i++;
...
rank[i] = [
		"Reduces the cooldown of your Fade ability by 2 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 1 second and the threat generated by your other Shadow spells is reduced by 5% while it is active.<br><br>[Note: The threat reduction component also applies to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus if it procs while in Shadowform.]",
		"Reduces the cooldown of your Fade ability by 4 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 2 seconds and the threat generated by your other Shadow spells is reduced by 10% while it is active.<br><br>[Note: The threat reduction component also applies to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus if it procs while in Shadowform.]",
		"Reduces the cooldown of your Fade ability by 6 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 3 seconds and the threat generated by your other Shadow spells is reduced by 15% while it is active.<br><br>[Note: The threat reduction component also applies to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus if it procs while in Shadowform.]"
		];
i++;
//Shadow Reach - Shadow
rank[i] = [
...
//Mind Melt - Shadow
rank[i] = [
		"Increases the critical strike chance of your Mind Blast spell by 2%.  Whenever your Mind Blast spell critically hits, it confuses the victim, attributing 60% of the threat caused by the spell to the victim's current target.<br><br>[Note: On crit, attributes 60% threat to victim's current target and 40% to you.  If you are the current target, 100% is attributed to you.  Other threat modifiers are applied first.]",
		"Increases the critical strike chance of your Mind Blast spell by 4%.  Whenever your Mind Blast spell critically hits, it confuses the victim, attributing 120% of the threat caused by the spell to the victim's current target.<br><br>[Note: On crit, attributes 120% threat to victim's current target and none to you.  If you are the current target, 120% is attributed to you.  Other threat modifiers are applied first.]",
		"Increases the critical strike chance of your Mind Blast spell by 6%.  Whenever your Mind Blast spell critically hits, it confuses the victim, attributing 180% of the threat caused by the spell to the victim's current target.<br><br>[Note: On crit, attributes 180% threat to victim's current target and none to you.  If you are the current target, 180% is attributed to you.  Other threat modifiers are applied first.]"
		];
i++;
//Darkness - Shadow
rank[i] = [
