...
rank[i] = [
		"Reduces the cooldown of your Fade ability by 2 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 1 second and the threat generated by your other Shadow spells is reduced by 5% while it is active.<br><br>[Note: The threat reduction component can apply to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus if it procs while in Shadowform.]",
		"Reduces the cooldown of your Fade ability by 4 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 2 seconds and the threat generated by your other Shadow spells is reduced by 10% while it is active.<br><br>[Note: The threat reduction component can apply to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus if it procs while in Shadowform.]",
		"Reduces the cooldown of your Fade ability by 6 seconds.  In addition, if Fade is used while in Shadowform, its duration is increased by 3 seconds and the threat generated by your other Shadow spells is reduced by 15% while it is active.<br><br>[Note: The threat reduction component can apply to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus if it procs while in Shadowform.]"
		];
i++;
//Shadow Reach - Shadow
rank[i] = [
