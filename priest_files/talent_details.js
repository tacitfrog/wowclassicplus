...
rank[i] = [
		"Reduces the cooldown of your Fade ability by 3 seconds.  In addition, if Fade is used while in Shadowform, the threat generated by your other Shadow spells is reduced by 10% while it is active.<br><br>[Note: The latter component also applies to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus.]",
		"Reduces the cooldown of your Fade ability by 6 seconds.  In addition, if Fade is used while in Shadowform, the threat generated by your other Shadow spells is reduced by 20% while it is active.<br><br>[Note: The latter component also applies to the Fade spell cast by the Transcendence (T2 set) 5-piece set bonus.]"
		];
i++;
//Shadow Reach - Shadow
rank[i] = [
