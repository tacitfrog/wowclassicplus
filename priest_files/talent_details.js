...
rank[i] = [
		"Increases the armour bonus of your Inner Fire spell by 10%.",
		"Increases the armour bonus of your Inner Fire spell by 20%.",
		"Increases the armour bonus of your Inner Fire spell by 30%."
		];
i++;
...
rank[i] = [
		"Reduces the casting time of your Mana Burn spell by 0.25 seconds.",
...
//Lightwell - Holy
rank[i] = [
		"Cast: 1.5 seconds.<br>Cost: Y mana.<br>Creates a holy Lightwell near the Priest.  Members of your raid or party can click the Lightwell to restore X health over 10 seconds.  Being attacked cancels the effect.  Lightwell lasts for 3 minutes or 5 charges.  (Cooldown: 10 minutes.)<br><br>[Rank 1: X = 800, &nbsp;&nbsp;Y = 225,<br>&nbsp;Rank 2: X = 1165, Y = 295 (level 50),<br>&nbsp;Rank 3: X = 1600, Y = 365 (level 60).]"
		];
i++;
...
//Spirit Tap - Shadow
rank[i] = [
		"Gives you a 20% chance to gain a 100% bonus to your Spirit after killing a target that yields experience.  For the duration, your mana will regenerate at a 50% rate while casting.  Lasts 15 seconds.",
		"Gives you a 40% chance to gain a 100% bonus to your Spirit after killing a target that yields experience.  For the duration, your mana will regenerate at a 50% rate while casting.  Lasts 15 seconds.",
		"Gives you a 60% chance to gain a 100% bonus to your Spirit after killing a target that yields experience.  For the duration, your mana will regenerate at a 50% rate while casting.  Lasts 15 seconds.",
		"Gives you a 80% chance to gain a 100% bonus to your Spirit after killing a target that yields experience.  For the duration, your mana will regenerate at a 50% rate while casting.  Lasts 15 seconds.",
		"Gives you a 100% chance to gain a 100% bonus to your Spirit after killing a target that yields experience.  For the duration, your mana will regenerate at a 50% rate while casting.  Lasts 15 seconds."
		];
i++;
//Blackout - Shadow
rank[i] = [
...
rank[i] = [
		"Decreases the cooldown of your Fade ability by 3 seconds.",
		"Decreases the cooldown of your Fade ability by 6 seconds."
		];
i++;
//Shadow Reach - Shadow
rank[i] = [
...
rank[i] = [
		"Cast: instant.<br>Range: 30 yards.<br>Cost: 40 mana.<br>Afflicts your target with Shadow energy that causes all party members to be healed for 20% of any Shadow spell damage you deal for 1 minute.  (Cooldown: 10 seconds.)"
		];
i++;
