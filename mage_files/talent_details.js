...
rank[i] = [
		...
		"Gives you a 4% chance of entering a Clearcasting state after any damage spell hits a target.  For Arcane Missiles, you have a 1.5% chance after each missile hits the target.  The Clearcasting state reduces the mana cost of your next spell by 100%.",
		"Gives you a 6% chance of entering a Clearcasting state after any damage spell hits a target.  For Arcane Missiles, you have a 2% chance after each missile hits the target.  The Clearcasting state reduces the mana cost of your next spell by 100%.",
		"Gives you a 8% chance of entering a Clearcasting state after any damage spell hits a target.  For Arcane Missiles, you have a 2.5% chance after each missile hits the target.  The Clearcasting state reduces the mana cost of your next spell by 100%.",
		"Gives you a 10% chance of entering a Clearcasting state after any damage spell hits a target.  For Arcane Missiles, you have a 3% chance after each missile hits the target.  The Clearcasting state reduces the mana cost of your next spell by 100%."
		];
i++;
...
rank[i] = [
		"When your Arcane Missiles or Arcane Explosion spells critically hit an enemy target, all members of your raid or party within 5 yards of the target will be healed for 5% of the damage caused.  This healing causes no threat.",
		"When your Arcane Missiles or Arcane Explosion spells critically hit an enemy target, all members of your raid or party within 5 yards of the target will be healed for 10% of the damage caused.  This healing causes no threat."
		];
i++;
//Arcane Power - Arcane
rank[i] = [
...
//Arctic Winds - Frost
rank[i] = [
		"Reduces the chance that you are hit by melee and ranged attacks by 2% and increases the amount of damage absorbed by your Frost Ward by 10%.",
		"Reduces the chance that you are hit by melee and ranged attacks by 4% and increases the amount of damage absorbed by your Frost Ward by 20%."
		];
i++;
//Ice Block - Frost
rank[i] = [
