...
//output the header
headerReplaceString += '<table><tr><td class="header">WOW Classic+ Project</td><td class="version">(v' + version + ')</td></tr></table>';

//output the icons
iconReplaceString += '<!--<div class="iconHolder"><a href="druid.htm" title="Druid Talents" class="druid ' + (className=="druid"?"active":"") + '"><img class="classIcon" src="img/class_druid.jpg"></a></div><//--><!--<div class="iconHolder"><a href="hunter.htm" title="Hunter Talents" class="hunter ' + (className=="hunter"?"active":"") + '"><img class="classIcon" src="img/class_hunter.jpg"></a></div><//--><div class="iconHolder"><a href="mage.htm" title="Mage Talents" class="mage ' + (className=="mage"?"active":"") + '"><img class="classIcon" src="img/class_mage.jpg"></a></div><!--<div class="iconHolder"><a href="paladin.htm" title="Paladin Talents" class="paladin ' + (className=="paladin"?"active":"") + '"><img class="classIcon" src="img/class_paladin.jpg"></a></div><//--><!--<div class="iconHolder"><a href="priest.htm" title="Priest Talents" class="priest ' + (className=="priest"?"active":"") + '"><img class="classIcon" src="img/class_priest.jpg"></a></div><//--><div class="iconHolder"><a href="rogue.htm" title="Rogue Talents" class="rogue ' + (className=="rogue"?"active":"") + '"><img class="classIcon" src="img/class_rogue.jpg"></a></div><!--<div class="iconHolder"><a href="shaman.htm" title="Shaman Talents" class="shaman ' + (className=="shaman"?"active":"") + '"><img class="classIcon" src="img/class_shaman.jpg"></a></div><//--><div class="iconHolder"><a href="warlock.htm" title="Warlock Talents" class="warlock ' + (className=="warlock"?"active":"") + '"><img class="classIcon" src="img/class_warlock.jpg"></a></div><!--<div class="iconHolder"><a href="warrior.htm" title="Warrior Talents" class="warrior ' + (className=="warrior"?"active":"") + '"><img class="classIcon" src="img/class_warrior.jpg"></a></div><//--><span class="divider">|</span><div class="iconHolder"><a href="alchemy.htm" title="Alchemy" class="alchemy ' + (className=="Alchemy"?"active":"") + '"><img class="classIcon" src="img/profession_alchemy.jpg"></a></div><div class="iconHolder"><a href="blacksmithing.htm" title="Blacksmithing" class="blacksmithing ' + (className=="Blacksmithing"?"active":"") + '"><img class="classIcon" src="img/profession_blacksmithing.jpg"></a></div><div class="iconHolder"><a href="enchanting.htm" title="Enchanting" class="enchanting ' + (className=="enchanting"?"active":"") + '"><img class="classIcon" src="img/profession_enchanting.jpg"></a></div><div class="iconHolder"><a href="engineering.htm" title="Engineering" class="engineering ' + (className=="Engineering"?"active":"") + '"><img class="classIcon" src="img/profession_engineering.jpg"></a></div><div class="iconHolder"><a href="leatherworking.htm" title="Leatherworking" class="leatherworking ' + (className=="leatherworking"?"active":"") + '"><img class="classIcon" src="img/profession_leatherworking.jpg"></a></div><div class="iconHolder"><a href="tailoring.htm" title="Tailoring" class="tailoring ' + (className=="Tailoring"?"active":"") + '"><img class="classIcon" src="img/profession_tailoring.jpg"></a></div><div class="iconHolder"><a href="gathering.htm" title="Gathering Professions" class="gathering ' + (className=="Gathering Professions"?"active":"") + '"><img class="classIcon" src="img/profession_herbalism.jpg"></a></div><span class="divider">|</span><div class="iconHolder"><a href="pve.htm" title="PvE" class="PvE ' + (className=="PvE"?"active":"") + '"><img class="classIcon" src="img/pve.jpg"></a></div><div class="iconHolder"><a href="pvp.htm" title="PvP" class="PvP ' + (className=="PvP"?"active":"") + '"><img class="classIcon" src="img/pvp.jpg"></a></div><div class="iconHolder"><a href="services.htm" title="Services" class="services ' + (className=="services"?"active":"") + '"><img class="classIcon" src="img/services.jpg"></a></div><div class="iconHolder"><a href="miscellaneous.htm" title="Miscellaneous" class="miscellaneous ' + (className=="miscellaneous"?"active":"") + '"><img class="classIcon" src="img/miscellaneous.jpg"></a></div>';
			...
			for (verticalCounter = 1; verticalCounter <= vertical; verticalCounter++)
			{
				...
				for (horizontalCounter = 1; horizontalCounter <= horizontal; horizontalCounter++)
				{
					...
					if (talent[i] && talent[i][4] == horizontalCounter && talent[i][5] == verticalCounter)
					{
						...
						talentsReplaceString += '<div style = "z-index: 99999; position: relative;"><div style = "top: -2px; left: -2px; position: absolute;"><img src = "' + pixelGif + '" width = "50px" height = "50px" border = "0" onClick = "rankTopOnClick('+ i +');" onMouseOver = "unhideTalent('+ i +'); hideOpenTalent('+ i +');" onMouseOut = "hideTalent('+ i +');" onContextMenu = "rankTopOnRightClick('+ i +'); return false;" /></div></div>';
...
document.getElementById('className').innerHTML = className.charAt(0).toUpperCase() + className.slice(1);
