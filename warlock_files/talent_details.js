...
rank[i] = [
		"Cast: 2 seconds.<br>Range: 30 yards.<br>Cost: A mana.<br>Imbeds a demon seed in the enemy target, causing X Shadow damage over 18 sec.  When the target takes X total damage or dies, the seed will inflict Y to Z Shadow damage to all other enemies within 15 yards of the target.  Only one Corruption spell per Warlock can be active on any one target.<br><br>[Note: Unlike other Afflication spells, the explosion can critically hit, but note that the talents Devastation and Ruin only affect Destruction spells and therefore do not affect this ability.]<br>[Rank 1: X = 324, Y = 164, Z = 204, A = 474,<br>&nbsp;Rank 2: X = 486, Y = 286, Z = 326, A = 580 (level 48),<br>&nbsp;Rank 3: X = 666, Y = 410, Z = 490, A = 722 (level 58).]"
		];
i++;
...
rank[i] = [
		"While you have a Firestone equipped, your Fire spells have a 10% chance to return health equal to 20% of the damage caused.  In addition, the bonus Fire damage from Firestones and the Firestone effect are increased by 10%.<br><br>[Note: If this effect triggers on Immolate, it first returns health based on the initial damage and then returns health each tick.  If it triggers on Rain of Fire or Hellfire, the health is returned after each wave of hits and is calculated off the total damage dealt in that wave.]",
		"While you have a Firestone equipped, your Fire spells have a 20% chance to return health equal to 20% of the damage caused.  In addition, the bonus Fire damage from Firestones and the Firestone effect are increased by 20%.<br><br>[Note: If this effect triggers on Immolate, it first returns health based on the initial damage and then returns health each tick.  If it triggers on Rain of Fire or Hellfire, the health is returned after each wave of hits and is calculated off the total damage dealt in that wave.]",
		"While you have a Firestone equipped, your Fire spells have a 30% chance to return health equal to 20% of the damage caused.  In addition, the bonus Fire damage from Firestones and the Firestone effect are increased by 30%.<br><br>[Note: If this effect triggers on Immolate, it first returns health based on the initial damage and then returns health each tick.  If it triggers on Rain of Fire or Hellfire, the health is returned after each wave of hits and is calculated off the total damage dealt in that wave.]"
		];
i++;
