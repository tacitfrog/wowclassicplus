...
rank[i] = [
		"Gives your Affliction effects an additional 10% chance to resist dispel and decurse effects.  If an enemy's dispel or decurse attempt fails, there is a 50% chance that they will instead suffer X to Y Shadow damage and be silenced for 4 seconds.<br><br>[Note: X = 4 * your current level, Y = 5 * your current level.]",
		"Gives your Affliction effects an additional 20% chance to resist dispel and decurse effects.  If an enemy's dispel or decurse attempt fails, there is a 50% chance that they will instead suffer X to Y Shadow damage and be silenced for 4 seconds.<br><br>[Note: X = 5 * your current level, Y = 6 * your current level.]",
		"Gives your Affliction effects an additional 30% chance to resist dispel and decurse effects.  If an enemy's dispel or decurse attempt fails, there is a 50% chance that they will instead suffer X to Y Shadow damage and be silenced for 4 seconds.<br><br>[Note: X = 6 * your current level, Y = 7 * your current level.]"
		];
i++;
