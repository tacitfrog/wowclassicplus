...
rank[i] = [
		"While you have a Firestone equipped, any Fire damage you deal has a 10% chance to heal you for 20% of the damage caused.  This healing causes no threat.  This effect cannot occur more than once per second.<br><br>[Note: This effect can trigger from your Firestone effect, Fire wands, or from Fire damage spells.  If it triggers on Immolate, health is returned only off the initial damage.  For Rain of Fire and Hellfire, it can trigger independently from any wave of hits and is calculated off the total damage dealt in that wave, but there is only one roll per wave so the trigger is independent of number of targets.]",
		"While you have a Firestone equipped, any Fire damage you deal has a 20% chance to heal you for 20% of the damage caused.  This healing causes no threat.  This effect cannot occur more than once per second.<br><br>[Note: This effect can trigger from your Firestone effect, Fire wands, or from Fire damage spells.  If it triggers on Immolate, health is returned only off the initial damage.  For Rain of Fire and Hellfire, it can trigger independently from any wave of hits and is calculated off the total damage dealt in that wave, but there is only one roll per wave so the trigger is independent of number of targets.]",
		"While you have a Firestone equipped, any Fire damage you deal has a 30% chance to heal you for 20% of the damage caused.  This healing causes no threat.  This effect cannot occur more than once per second.<br><br>[Note: This effect can trigger from your Firestone effect, Fire wands, or from Fire damage spells.  If it triggers on Immolate, health is returned only off the initial damage.  For Rain of Fire and Hellfire, it can trigger independently from any wave of hits and is calculated off the total damage dealt in that wave, but there is only one roll per wave so the trigger is independent of number of targets.]"
		];
i++;
