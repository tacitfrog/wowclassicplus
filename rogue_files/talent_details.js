...
rank[i] = [
		"Gives your Eviscerate ability a chance to activate doses of your Deadly Poison or Wound Poison on the target.  Each combo point has a separate 20% chance to activate one dose.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, the Deadly Poison doses will be activated first.  Each activated dose applies your highest learned rank of Instant Poison.]",
		"Gives your Eviscerate ability a chance to activate doses of your Deadly Poison or Wound Poison on the target.  Each combo point has a separate 40% chance to activate one dose.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, the Deadly Poison doses will be activated first.  Each activated dose applies your highest learned rank of Instant Poison.]",
		"Gives your Eviscerate ability a chance to activate doses of your Deadly Poison or Wound Poison on the target.  Each combo point has a separate 60% chance to activate one dose.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, the Deadly Poison doses will be activated first.  Each activated dose applies your highest learned rank of Instant Poison.]"
		];
i++;
