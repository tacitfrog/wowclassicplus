...
rank[i] = [
		"While in combat with a target that is affected by your Garrote or Rupture abilities, 1% of the threat generated by all Physical damage dealt to the target by members of your raid or party is transferred to you.<br><br>[Note: This considers the Physical damage component of all attacks from all sources in your raid or party.  You become a passive threat vent for other players.  If you Vanish, the re-direction stops; it will restart if you re-enter combat with that target.]",
		"While in combat with a target that is affected by your Garrote or Rupture abilities, 2% of the threat generated by all Physical damage dealt to the target by members of your raid or party is transferred to you.<br><br>[Note: This considers the Physical damage component of all attacks from all sources in your raid or party.  You become a passive threat vent for other players.  If you Vanish, the re-direction stops; it will restart if you re-enter combat with that target.]"
		];
i++;
