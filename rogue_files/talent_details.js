...
rank[i] = [
		"Your Eviscerate ability has a 50% chance to activate 1 dose of your Deadly Poison or Wound Poison on the target per combo point, up to a maximum of 1.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, Deadly Poison doses will be activated first.  Each activated dose applies your highest learned rank of Instant Poison to the target; these applications of Instant Poison are summed and applied as a single attack of Nature damage called 'Envenom'.  Before summing, each application of Instant Poison can critically hit as usual and benefits from the damage bonus given by Vile Poisons.  After summing, the target can resist the Envenom attack as usual.  The Envenom attack is applied to the target with the Eviscerate in the same way as how Instant Poison is applied when it procs from a regular attack.]",
		"Your Eviscerate ability has a 50% chance to activate 1 dose of your Deadly Poison or Wound Poison on the target per combo point, up to a maximum of 2.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, Deadly Poison doses will be activated first.  Each activated dose applies your highest learned rank of Instant Poison to the target; these applications of Instant Poison are summed and applied as a single attack of Nature damage called 'Envenom'.  Before summing, each application of Instant Poison can critically hit as usual and benefits from the damage bonus given by Vile Poisons.  After summing, the target can resist the Envenom attack as usual.  The Envenom attack is applied to the target with the Eviscerate in the same way as how Instant Poison is applied when it procs from a regular attack.]",
