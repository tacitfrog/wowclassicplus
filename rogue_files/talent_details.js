...
//Blade Dance - Combat
rank[i] = [
		"Cast: instant.<br>Cost: 25 energy.<br>Finishing move that increases your parry chance, your threat generation, and periodically causes threat to all nearby enemies, making them more likely to attack you.  Lasts longer and grants more parry chance per combo point:<br>&nbsp;&nbsp;1 point: &nbsp;&nbsp;9 seconds, &nbsp;&nbsp;X% parry<br>&nbsp;&nbsp;2 points: 12 seconds, Y% parry<br>&nbsp;&nbsp;3 points: 15 seconds, Z% parry<br>&nbsp;&nbsp;4 points: 18 seconds, A% parry<br>&nbsp;&nbsp;5 points: 21 seconds, B% parry<br><br>[Rank 1: X = 3, Y = 6, Z = 9, &nbsp;&nbsp;A = 12, B = 15,<br>&nbsp;Rank 2: X = 4, Y = 8, Z = 12, A = 16, B = 20 (level 48).]<br><br>[Note: While active, increases all threat generated by 25% to cancel out the Rogue class' passive 20% reduction.  Also, pulses threat to all enemies within 10 yards every 2 seconds; the amount of threat pulsed is 75/100 at Rank 1/2, subject to further balancing, and is intended to counter light healing agro in targets other than the main target.]"
		];
i++;
//Blade Flurry - Combat
rank[i] = [
...
rank[i] = [
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 10%.",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 20%.  More effective than Master of Deception (Rank 1).",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 30%.  More effective than Master of Deception (Rank 2).",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 40%.  More effective than Master of Deception (Rank 3).",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 50%.  More effective than Master of Deception (Rank 4)."
		];
i++;
...
rank[i] = [
		"While a target is affected by your Garrote or Hemorrhage effects, 2% of the threat generated by all Physical damage caused to the target from any source is directed to you.",
		"While a target is affected by your Garrote or Hemorrhage effects, 4% of the threat generated by all Physical damage caused to the target from any source is directed to you."
		];
i++;
