...
rank[i] = [
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 5%.",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 10%.  More effective than Master of Deception (Rank 1).",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 15%.  More effective than Master of Deception (Rank 2).",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 20%.  More effective than Master of Deception (Rank 3).",
		"Reduces the chance enemies have to detect you while in Stealth mode and increases the effectiveness of your Feint ability by 25%.  More effective than Master of Deception (Rank 4)."
		];
i++;
...
rank[i] = [
		"While a target is affected by your Garrote ability, 2% of the threat generated by Physical damage dealt to the target from all sources is re-directed to you.",
		"While a target is affected by your Garrote ability, 4% of the threat generated by Physical damage dealt to the target from all sources is re-directed to you."
		];
i++;
