...
rank[i] = [
		"While in combat with a target that is affected by your Garrote or Rupture abilities, causes 1% of all the threat generated by Physical damage dealt to the target by members of your raid or party to be transferred to you.<br><br>[Note: You become a passive threat vent for other players.  If you Vanish, the re-direction stops; it will restart if you re-enter combat with that target.]",
		"While in combat with a target that is affected by your Garrote or Rupture abilities, causes 2% of all the threat generated by Physical damage dealt to the target by members of your raid or party to be transferred to you.<br><br>[Note: You become a passive threat vent for other players.  If you Vanish, the re-direction stops; it will restart if you re-enter combat with that target.]"
		];
i++;
