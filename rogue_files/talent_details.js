...
//Blade Dance - Combat
rank[i] = [
		"Cast: instant.<br>Cost: 25 energy.<br>Finishing move that increases your parry chance and periodically causes threat to all nearby enemies, making them more likely to attack you.  Lasts longer and grants more parry chance per combo point:<br>&nbsp;&nbsp;1 point: &nbsp;&nbsp;9 seconds, &nbsp;&nbsp;X% parry<br>&nbsp;&nbsp;2 points: 12 seconds, Y% parry<br>&nbsp;&nbsp;3 points: 15 seconds, Z% parry<br>&nbsp;&nbsp;4 points: 18 seconds, A% parry<br>&nbsp;&nbsp;5 points: 21 seconds, B% parry<br><br>[Rank 1: X = 3, Y = 6, Z = 9, &nbsp;&nbsp;A = 12, B = 15,<br>&nbsp;Rank 2: X = 4, Y = 8, Z = 12, A = 16, B = 20 (level 48).]"
		];
i++;
//Blade Flurry - Combat
rank[i] = [
		"Cast: instant.<br>Cost: 25 energy.<br>Increases your attack speed by 20%.  In addition, attacks strike an additional nearby opponent.  Lasts 15 seconds.  (Cooldown: 2 minutes.)<br><br>[Note: Any poison procs and on-hit effects that your weapons apply to the main target are also applied to the additional target.]"
		];
i++;
...
rank[i] = [
		"While a target is affected by your Garrote or Hemorrhage effects, 2% of the threat generated by all Physical attacks that strike the target from any source is attributed to you.",
		"While a target is affected by your Garrote or Hemorrhage effects, 4% of the threat generated by all Physical attacks that strike the target from any source is attributed to you."
		];
i++;
