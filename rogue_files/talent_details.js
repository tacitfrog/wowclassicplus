...
rank[i] = [
		"Your Eviscerate ability has a 50% chance to activate 1 dose of your Deadly Poison or Wound Poison on the target per combo point, up to a maximum of 1.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, Deadly Poison doses will be activated first.  The calculation is made as follows.  First, a 50% roll is made per combo point to see how many doses are activated, then this number is capped by the maximum and by the number of doses available.  Second, the damage for each dose is rolled using your highest learned rank of Instant Poison.  Each one has a small chance to critically hit as usual.  These Instant Poison damage numbers are summed together to give the total damage for the Envenom.  Third, this Envenom is applied to the target as a single application in the same way as an Instant Poison proc (it can be resisted as usual).  The 50% activation chance is increased by Improved Poisons and similar effects.  The damage is increased by Vile Poisons.]",
		"Your Eviscerate ability has a 50% chance to activate 1 dose of your Deadly Poison or Wound Poison on the target per combo point, up to a maximum of 2.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, Deadly Poison doses will be activated first.  The calculation is made as follows.  First, a 50% roll is made per combo point to see how many doses are activated, then this number is capped by the maximum and by the number of doses available.  Second, the damage for each dose is rolled using your highest learned rank of Instant Poison.  Each one has a small chance to critically hit as usual.  These Instant Poison damage numbers are summed together to give the total damage for the Envenom.  Third, this Envenom is applied to the target as a single application in the same way as an Instant Poison proc (it can be resisted as usual).  The 50% activation chance is increased by Improved Poisons and similar effects.  The damage is increased by Vile Poisons.]",
		"Your Eviscerate ability has a 50% chance to activate 1 dose of your Deadly Poison or Wound Poison on the target per combo point, up to a maximum of 3.  Each activated dose is consumed and deals Instant Poison damage to the target.<br><br>[Note: If you have applied both types of poison to your target, Deadly Poison doses will be activated first.  The calculation is made as follows.  First, a 50% roll is made per combo point to see how many doses are activated, then this number is capped by the maximum and by the number of doses available.  Second, the damage for each dose is rolled using your highest learned rank of Instant Poison.  Each one has a small chance to critically hit as usual.  These Instant Poison damage numbers are summed together to give the total damage for the Envenom.  Third, this Envenom is applied to the target as a single application in the same way as an Instant Poison proc (it can be resisted as usual).  The 50% activation chance is increased by Improved Poisons and similar effects.  The damage is increased by Vile Poisons.]"
		];
i++;
